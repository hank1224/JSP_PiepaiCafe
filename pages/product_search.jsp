...
<header>
        <nav>
            <ul class="navbar" style="height: 120px;">
                ...
                <!--logo-->
                <li class="protrait"></li>
                <li class="navbar-option"><a href="./auoutus.jsp" class="aboutus">關於我們</a></li>
                <li class="navbar-option">
                    <a href="member.jsp"><span>會員資訊</span></a>
                    <ul>
                        <li><button class="btn01" onclick="document.getElementById('id01').style.display='block'"
                                style="width:120px; background-color: white; color: black; height:60px; margin-left: 0px;font-size:15px;">登入</button>
                        </li>
                        <li><button class="btn01" onclick="document.getElementById('id02').style.display='block'"
                                style="width:120px; background-color: white; color: black; height:60px; margin-left: 0px;font-size:15px;">註冊</button>
                        </li>
                    </ul>
                </li>
                <!--搜尋-->
                ...
                <div class="right-navbar-option"><a href="../pages/index.jsp"><img src="../assets/img/icon/home2.png"
                            alt=""></a></div>
                <div class="right-navbar-option"><a href="../pages/checkout.jsp"><img
                            src="../assets/img/icon/shoppingcart.png"></a></div>
        ...
        <div class="title">
                ...
                <div id="id01" class="modal">
                    ...
                    <form class="modal-content animate" action="check.jsp" method="post">
                        ...
                        <div class="container"><br>
                            ...
                            <input type="password" placeholder="請輸入密碼" name="pwd" required
            ...
            <div class="register">
                <button class="btn01" onclick="document.getElementById('id02').style.display='block'"
                    style="width:80px;margin-left:500px;margin-top: 30px;position: absolute;">註冊</button>
                ...
                <div id="id02" class="modal">
                    ...
                    <form class="modal-content1 animate" action="add.jsp" method="post">
                        ...
                        <div class="container"><br>
                            ...
                            <input type="text" placeholder="Tina12345@gmail.com" name="email" 
                                style="border-radius: 10px;">
                            <br>
                            <label for="psw" style="color: black;size: 10px;"><b><br>電話</b></label>
                            <input type="text" placeholder="0912345678" name="phone" required
                                style="border-radius: 10px;">
                            <br>
                            <label for="psw" style="color: black;size: 10px;"><b><br>地址</b></label>
                            <input type="text" placeholder="桃園市中北路200號" name="address" 
                                style="border-radius: 10px;"> <br> <br>
...
<center>
<div style="margin-top:8%;background-image:url(../assets/img/background.jpg);background-repeat: no-repeat;
    background-size: cover;
    height: 3000px;
    width: 1903px;
    padding-top: 20px;" >
<h1 style="margin-left: -90px;">搜尋結果</h1><br>
...
try {
    ...
    try {
        if(con.isClosed())
           ...
           sql = "SELECT * from products WHERE cakeName like '%" + request.getParameter("search")+"%'; ";
           con.createStatement().execute(sql);
           ResultSet rs=con.createStatement().executeQuery(sql);

            //out.println("<div class='a-s2-right'><div class='a-s2-r-first'>");

	        while(rs.next()){
                out.println("<div class='a-s2-r-f-one' style='margin-left: -80px;'><form method='post' action='product.jsp'><div class=''>");
                ...
                out.println("<input type='hidden' name='id' value='" + rs.getString("cid") + "'></div></form>");
                ...
                out.println("<button type='submit' name='productid' value='" + rs.getString("cid") + "' style='width: 350px; height: 40px; margin-top: 15px; margin-left: 0px; background-color: bisque; color: rgb(131, 130, 106); border: none; font-size: 15px; cursor: pointer;'>");
                out.println("加入購物車</button></form></div>");
            }
