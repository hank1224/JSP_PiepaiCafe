...
<%
           ...
           if(current_page==0) //若未指定page, 令current_page為1
			...
			if(current_page!=1)
			out.print("<center><a href='mmember.jsp?page="+1+"'><button type='button'>第一頁</button></a>&nbsp;");	
			if(current_page>=2)
			out.print("<center><a href='mmember.jsp?page="+(current_page-1)+"'><button type='button'>上一頁</button></a>&nbsp;");	
			if(current_page<page_num)
			out.print("<center><a href='mmember.jsp?page="+(current_page+1)+"'><button type='button'>下一頁</button></a>&nbsp;");			
			if(current_page<page_num)
			out.print("<center><a href='mmember.jsp?page="+(page_num)+"'><button type='button'>最後一頁</button></a>&nbsp;");			
           ...
           sql+=start_record+",5";
		    rs=con.createStatement().executeQuery(sql);
                ...
                String new_address = new String(rs.getString("address").getBytes("ISO-8859-1"),"UTF-8");
				...
				out.println("<td>"+new_address+"</td>");
				out.print("<td><a href='delete.jsp?id="+rs.getString("id")+"';><button>刪除</button></a></td>");
				}
%>
