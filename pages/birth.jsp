...
<body>
                ...
                <div id="id02" class="modal">
                    ...
                    <form class="modal-content1 animate" action="add.jsp" method="post">
                        ...
                        <div class="container"><br>
                            ...
                            <input type="text" placeholder="Tina12345@gmail.com" name="email" required
                                style="border-radius: 10px;">
                            <br>
                            ...
                            <input type="text" placeholder="桃園市中北路200號" name="address" required
                                style="border-radius: 10px;"> <br><br>
    ...
    <div class="all" style=" height: 1650px;">
        ...
        <div class="a-section2">
            <div class="a-s2-left">
                <div class="a-s2-l-all">
                    <a href="./allproduct.jsp" style="text-decoration:none;font-size: 25px;">所有商品</a>
                </div>
            ...
            <div class="a-s2-right">
                <div class="a-s2-r-first">
                    <%
                        sql = "SELECT * FROM `products` WHERE `class`='birth'";
